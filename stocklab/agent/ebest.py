...
class EBest:
    ...
    def __init__(self, mode=None):
        ...
        self.account_passwd = config[run_mode]['account_passwd']
    ...
    def get_stock_price_by_code(self, code=None, cnt="1"):
        ...
        print(">>>> [get_stock_price_by_code] ebest call....")
        print(in_params)
        ...
        out_params =['date', 'open', 'high', 'low', 'close', 'sign', 
                    ...
                    'sojinrate', 'changerate', 'fpvolume', 'covolume', 'shcode',
    ...
    def get_code_list(self, market=None):
        ...
        out_params =['hname', 'shcode', 'expcode', 'etfgubun', 'jnilclose', 'memedan', 'gubun', 'spac_gubun'] 
    ...
    def get_credit_trend_by_code(self, code=None, date=None):
        ...
        out_params =["mmdate", "close", "sign", "jchange", "diff", "nvolume",
                    "svolume", "jvolume", "prget_price_n_min_by_codeice", "change", "gyrate", "jkrate"
                    "shcode"]
    ...
    def get_account_info(self):
        ...
        """
        in_params = {"RecCnt":"1", "AcntNo": self.account, "Pwd": self.account_passwd}
    ...
    def get_account_stock_info(self):
        ...
        """
        in_params = {"RecCnt": "1", "AcntNo": self.account, "Pwd": self.account_passwd, "BalCreTp": "0", "CmsnAppTpCode": "0", "D2balBaseQryTp": "0", "UprcTpCode": "0"}
    ...
    def order_check(self, order_no=None):
        ...
        """
        in_params = {"accno": self.account, "passwd": self.account_passwd, "expcode": "", 
    ...
    def order_check2(self, date, code, order_no=None):
        ...
        in_params = {"RecCnt":"1", "AcntNo":self.account, "InptPwd":self.account_passwd, "OrdMktCode":"00", 
    ...
    def order_stock(self, code, qty, price, bns_type, order_type="00"):
        ...
        """
        in_params = {"AcntNo":self.account, "InptPwd":self.account_passwd, "IsuNo":code, "OrdQty":qty,
    ...
    def order_cancel(self, order_no, code, qty):
        ...
        """
        in_params = {"OrgOrdNo":order_no,"AcntNo":self.account, "InptPwd":self.account_passwd, "IsuNo":code, "OrdQty":qty}
    ...
    def get_price_n_min_by_code(self, sdate, edate,  code, tick=None):
        #back testing
        """TR: t8412 주식차트(N분) 
        :param code:str 종목코드
        :param date:str 시작시간
        ...
        """
        in_params = {"shcode":code,"ncnt":"1", "qrycnt":"500", "nday":"1", "sdate":sdate, 
                "stime":"090000", "edate":edate, "etime":"153000", "cts_date":"00000000", 
        ...
        '''
        result = {}
        for idx, item in enumerate(result_list):L 
            print (item)
            result[idx] = item
...
class XAQuery:
    ...
    def OnReceiveMessage(self, error, code, message):
        ...
        print ("OnreceiveMessage", error, code)
